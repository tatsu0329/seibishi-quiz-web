          ...
          <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-800 md:p-8">
            ...
            <div className="space-y-6">
              ...
              <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                国家資格である自動車整備士の等級を選択してください。1級は最も高度な知識と技能が求められます。
              </p>
              <div className="mb-4 rounded-lg bg-gray-50 p-3 text-xs text-gray-600 dark:bg-gray-700/50 dark:text-gray-400">
                <h3 className="mb-1 font-semibold text-gray-700 dark:text-gray-300">等級について</h3>
                <ul className="space-y-1">
                  <li>• <strong>1級</strong>: 自動車の整備に関する高度な知識と技能が必要</li>
                  <li>• <strong>2級</strong>: 自動車の整備に関する一般的な知識と技能が必要</li>
                  <li>• <strong>3級</strong>: 自動車の基本的な整備に関する知識と技能が必要</li>
                </ul>
              </div>
            ...
            {selectedLevel && (
              <section>
                ...
                <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                  小型自動車、ディーゼル、ガソリンのいずれかを選択してください。
                </p>
                <div className="mb-4 rounded-lg bg-gray-50 p-3 text-xs text-gray-600 dark:bg-gray-700/50 dark:text-gray-400">
                  <h3 className="mb-1 font-semibold text-gray-700 dark:text-gray-300">燃料タイプについて</h3>
                  <ul className="space-y-1">
                    <li>• <strong>小型</strong>: 小型自動車整備士（1級のみ）</li>
                    <li>• <strong>ディーゼル</strong>: ディーゼルエンジンに関する問題</li>
                    <li>• <strong>ガソリン</strong>: ガソリンエンジンに関する問題</li>
                  </ul>
                </div>
            ...
            {selectedFuelType && (
              <section>
                ...
                <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                  過去の試験実施年度を選択してください。最新の年度から順に表示されています。複数の年度の問題を解くことで、より幅広い知識を身につけることができます。
                </p>
